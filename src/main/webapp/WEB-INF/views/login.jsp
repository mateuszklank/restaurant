					...
					<form action='<spring:url value="/loginAction"/>' method="post">
						<fieldset>
							...
							<div class="form-group">
								<input class="form-control" placeholder="<spring:message code="login.name"/>" name='username' type="text">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="<spring:message code="login.pass"/>" name='password' type="password" value="">
							</div>
							<div class="w3-center w3-padding-32">
								<div class="w3-bar">
									<input class="w3-bar-item w3-black w3-button" type="submit" value="<spring:message code="login.log"/>">
