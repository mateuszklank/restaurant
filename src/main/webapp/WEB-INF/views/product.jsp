						...
						<div class="w3-quarter">
							<div class="thumbnail">
								...
								<div class="w3-center w3-padding-32">
									<div class="w3-bar">
										<a href="<spring:url value="/products"/>" class="w3-bar-item w3-black w3-button">
						...
						<div class="w3-quarter">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<p>Kategoria<br>${product.category}</p>
									<p>Kod produktu<br>${product.productId}</p>
								</div>
							</div>
						</div>
						<div class="w3-quarter">
							<div class="thumbnail">
								<div class="w3-center w3-padding-32">
									<div class="w3-bar">
										<a href="<spring:url value="/products"/>" class="w3-bar-item w3-black w3-button">
											<spring:message code="product.order"/>
										</a>
									</div>
								</div>
								<div class="caption">
