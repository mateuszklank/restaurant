    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
        ...
        <div class="w3-container w3-padding-32 w3-center">
            <div class="w3-padding-32">
                <h4><b>Dodawanie nowego produktu do Menu</b></h4>
                <hr>
                <p>Uzupełnij pola w celu dodania nowego produktu. Pamiętaj, że identyfikator produktu musi składać się z litery P i ciągu cyfr, a zdjęcie produktu być w formacie .png i wymiarach 450x675</p>
                <hr>
            </div>
        </div>
